...
var closeInformation = require('transactions-interface-state').default.closeInformation;
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.isActive && !isActive) {
        if (isMockUser) {
          ...
          dispatch((0, _transactionsReduxNormalizer.mergeNormalizerEntities)('notifications', entities));
        } else {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { className: classes, onClick: function onClick() {
            return dispatch(closeInformation());
          } },
