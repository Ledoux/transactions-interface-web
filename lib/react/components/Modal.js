  ...
  return _react2.default.createElement(
    ...
    { className: (0, _classnames2.default)({
      ...
      onClick: function onClick() {
        return isOutCloseButton && onCloseClick();
      } },
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        ContentComponent && _react2.default.createElement(ContentComponent, null)
      ),
      isCtaCloseButton && _react2.default.createElement(
        'div',
        { className: 'modal__close-cta' },
        _react2.default.createElement(_IconButton2.default, { className: 'button button--alive icon-button',
          icon: 'cross',
          onClick: onCloseClick,
          text: 'Close' })
      )
