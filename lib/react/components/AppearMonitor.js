...
var AppearMonitor = function (_InViewMonitor) {
  _inherits(AppearMonitor, _InViewMonitor);

  function AppearMonitor() {
    _classCallCheck(this, AppearMonitor);

    return _possibleConstructorReturn(this, (AppearMonitor.__proto__ || Object.getPrototypeOf(AppearMonitor)).apply(this, arguments));
  }

  _createClass(AppearMonitor, [{
    key: '_handleScroll',
    value: function _handleScroll() {
      var yOffset = window.pageYOffset;
      var _props = this.props,
          classNameOnScrollIntoView = _props.classNameOnScrollIntoView,
          childPropsOnScrollIntoView = _props.childPropsOnScrollIntoView,
          classNameInitial = _props.classNameInitial;
  ...
  return AppearMonitor;
}(_reactInviewMonitor2.default);

exports.default = AppearMonitor;