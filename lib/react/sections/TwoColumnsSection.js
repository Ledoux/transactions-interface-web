...
var TwoColumnsSection = function TwoColumnsSection(_ref) {
  ...
  var illustrationElement = _react2.default.createElement(
    ...
    iconTag && _react2.default.createElement(_components.Icon, { className: 'two-columns-section__illustration__icons\n        two-columns-section__illustration__icons--' + iconTag,
  ...
  return _react2.default.createElement(
    _components.Section,
    { extraClass: (0, _classnames4.default)('two-columns-section', (_classnames2 = {}, _defineProperty(_classnames2, 'two-columns-section--' + tag, tag), _defineProperty(_classnames2, extraClass, extraClass), _classnames2)),
      isFullHeight: isSplit },
    isSplit && isContentRight ? [illustrationElement, contentElement] : [contentElement, illustrationElement]
  );
};

exports.default = (0, _reactRedux.connect)(function (_ref2) {
  var _ref2$browser$greater = _ref2.browser.greaterThan,
      medium = _ref2$browser$greater.medium,
      large = _ref2$browser$greater.large;
  return {
    isSplit: large
  };
})(TwoColumnsSection);