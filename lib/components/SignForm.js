  ...
  _createClass(SignForm, [{
    ...
    value: function componentDidMount() {
      ...
      if (returnMessage) {
        ...
        _Root.history.push(window.location.pathname);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { className: 'sign-form p3',
          method: 'post',
          action: _api.SIGN_PATH + '/' + endpoint
        },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            {
              className: _classes.BUTTON_CLASS + ' button--cta',
              type: 'submit'
            },
            isSignin && 'Sign In',
            isSignup && 'Sign Up'
...
exports.default = (0, _reactRedux.connect)(null, {
  ...
  showModalWarning: _modal.showModalWarning
})(SignForm);